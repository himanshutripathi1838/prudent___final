...
export default function GlowHorizon({ className = "", variant = "top" }) {
  const { axis, scaleAxis, enterPct, restPct } = VARIANTS[variant] || VARIANTS.top;
  ...
  return (
    ...
    >
      ...
      <Arc variant={variant} color="rgba(11, 15, 23, 0.85)" size="120%" initialOffset="10%" blur={51} delay={0} />
    </motion.div>
  );
}
