  ...
  return (
    <div className="min-h-screen bg-[#0A0E14] text-slate-100 font-sans">
      ...
      <section className="border-b border-[#1E293B] py-16 sm:py-24 bg-[#0A0E14] relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:px-8 relative z-10">
          ...
          >
            <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-[#00E5FF] to-blue-600 opacity-20 blur-xl group-hover:opacity-40 transition-all duration-500 pointer-events-none" />
            <motion.img
              ...
              width="1200"
              height="800"
              className="aspect-[4/3] w-full rounded-3xl border border-[#00E5FF]/30 object-cover shadow-2xl relative z-10"
            />
          </motion.div>
